...
<form action="{{route('profile.update')}}" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group text-center align-items-center justify-content-center d-flex flex-column">
        <img id="preview-profile-image" src="{{asset($profile->image)}}" alt="..."  onerror="this.onerror=null; this.src=`{{asset('/images/dummy/no-person-img.jpg')}}`" class=" text-center @error('profile_image_input') border border-danger @else preview-profile-image-border  @enderror" style="width:102px;height:102px;">

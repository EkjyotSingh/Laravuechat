...
<form action="{{route('profile.update')}}" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group text-center align-items-center justify-content-center d-flex flex-column">
        <img src="{{asset('storage/'.$profile->image)}}" alt="..."  onerror="this.onerror=null; this.src=`{{asset('/images/dummy/no-person-img.jpg')}}`" class=" text-center border @error('profile_image_input') border-danger @else border-dark  @enderror" style="width:102px;height:102px;">
        ...
        <input type="file" class="d-none" name="profile_image_input" id="profile_image_input">
